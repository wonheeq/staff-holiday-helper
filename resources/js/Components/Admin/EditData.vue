...
<template>
    <Modal>
        <div class="h-screen flex items-center w-screen bg-transparent">
            <div class="w-3/6 4k:w-[70rem] flex flex-col p-4 mx-auto h-4/7 4k:h-[48rem] rounded-tl-md overflow-auto" :class="subpageClass">
                ...
                <div class="flex mt-5 justify-center">
                    <button class="bg-[#e3e3e3] px-6 py-2 ml-4 text-center w-28 text-lg 4k:text-3xl 4k:mt-2 4k:w-36"
                        @click="updateTuple()">
                        Update 
                    </button>
                </div>
