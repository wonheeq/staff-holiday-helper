...
<template>
    <div class="flex mb-2.5 mt-2.5 w-full">
        <div class="flex space-x-4 1080:space-x-7 ml-2 1080:ml-2.5 1440:ml-3 4k:ml-4 w-full mr-2 justify-between">
            <div class="flex space-x-6 4k:space-x-8">
                <input type="checkbox"
                ...
                />
                <p class="text-xs 1080:text-lg 1440:text-xl 4k:text-2xl h-full w-[12rem] 1080:w-[22rem] 1440:w-[31rem] 4k:w-[48rem]">
                    {{ nomination.role }}
                </p>
            </div>
            <p class="text-xs 1080:text-lg 1440:text-xl 4k:text-2xl h-full w-[11rem] 1080:w-[17rem] 1440:w-[20rem] 4k:w-[32rem]">
                {{ nomination.nomination }}
            </p>
            <NomineeDropdown
                class="w-[12rem] 1080:w-[17rem] 1440:w-[22rem] 4k:w-[32rem]"
                :options="options"
