...
<template>
    <div class="flex flex-row justify-between border-2 rounded-md bg-white drop-shadow-md">
        <div class="flex flex-row space-x-2 laptop:space-x-4 ml-2 laptop:ml-4 my-2 items-center">
        ...
        <div class="flex flex-row laptop:space-x-2 1440:space-x-4 laptop:mr-2 my-2">
