...
<Modal>
    <div class="bg-white w-3/5 1080:w-1/2 1440:w-2/6 h-[32rem] 1080:h-[48rem] rounded-md p-4" v-if="props.data">
        <div class="flex h-[10%] items-center justify-between">
            <p class="text-lg laptop:text-base 1080:text-3xl 1440:text-2xl 4k:text-4xl font-bold">
        ...
        <div class="flex h-[6%] items-center justify-between">
            <p class="text-m laptop:text-base 1080:text-3xl 1440:text-2xl 4k:text-4xl">
        ...
        <div class="h-[29%] py-4">
            <p class="h-[20%] text-lg 1080:text-xl 4k:text-2xl pb-8">
