<mjml>
    <mj-head>
      <mj-title>AppCancelled</mj-title>
      <mj-preview>Application Cancelled</mj-preview>
      <mj-attributes>
        ...
        <mj-section background-size="cover" padding="0px">
          ...
          <mj-column vertical-align="middle" width="80%" background-color="#FFFFFF">
            <mj-text color="#212b35" font-weight="bold" font-size="20px" align="center">
              Staff Member Cancelled Application
            </mj-text>
            ...
            <mj-text color="#637381" font-size="16px">
           	...
           	<mj-text color="#637381" font-size="16px">
                This application belonged to {{ $dynamicData['applicantName'] }} ({{ $dynamicData['applicantId'] }}).
            </mj-text>
            ...
            <mj-text color="#637381" font-size="16px">
                To acknowledge this message, please log in to LeaveOnTime by pressing the button below or following the link at the end of this email.
            </mj-text>
