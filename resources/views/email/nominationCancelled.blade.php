<mjml>
    <mj-head>
      <mj-title>NominationCancelled</mj-title>
      <mj-preview>Nomination Cancelled</mj-preview>
      <mj-attributes>
    ...
    <mj-body width="600px">
        ...
        <mj-section background-size="cover" padding="0px">
          ...
          <mj-column vertical-align="middle" width="80%" background-color="#FFFFFF">
            ...
            <mj-text color="#637381" font-size="16px">
                This application was cancelled by {{ $dynamicData['senderName'] }} ({{ $dynamicData['senderNo'] }}).
              </mj-text>
