...
class MessageControllerTest extends TestCase
{
    ...
    {
        $response = $this->getJson("/api/allMessages/{$this->adminUser['accountNo']}");
        $response->assertStatus(200);

        $response = $this->getJson("/api/allMessages/{$this->otherUser1['accountNo']}");
        $response->assertStatus(500);

        $response = $this->getJson("/api/allMessages/{$this->otherUser2['accountNo']}");
        $response->assertStatus(500);
    }
